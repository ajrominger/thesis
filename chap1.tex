...
\cite{bak1993, sole1997} to invocations of non-linear environmental
perturbations \cite{newman1995} and escalatory co-evolutionary
interactions \cite{vermeij1987}. New data and analyses have not
supported any of these hypotheses at the scale of the entire
Phanerozoic marine invertebrate fauna \cite{kirchner1998, madin2006,
  alroy08}. Other studies have modeled the mean trend in diversity as
tracking a potentially evolving equilibrium \cite{sepkoski1984,
  alroy08, alroy2010, rabosky2009ecolLett} and yet ignore the
potential role of stochasticity and non-equilibrium dynamics in
producing observed patterns \cite{erwin2012, liow2007,
...
\item long periods of niche conservatism are interrupted by adaptive
  ...
  \cite{eldredgeGould1972, newman1985adaptive, hopkins2014}; and
\item as a consequence of the interaction between their life history
  ...
  \cite{vrba1983} different clades experience different rates of
  morphological evolution, speciation and extinction
  \cite{simpson1953, sepkoski1984, holman1989, gilinsky1994}.
\end{inparaenum}
...
punctuated equilibrium \cite{eldredgeGould1972}. Here we show that
this punctuation is actually akin to the ``super statistical theory''
of non-equilibrium dynamics in statistical physics
\cite{beck2003}. Super-statistics \cite{beck2003} proposes that
...
determines the dynamics of the complete system \cite{beck2003}. When
...
taxa \cite{simpson1953, gavrilets2005, rabosky2009ecolLett, price2014}
...
niche space. Larval type \cite{jablonski2008}, body plan
\cite{erwin2012}, body size \cite{harnik2011}, range size
\cite{harnik2011, foote2008paleobiol} and substrate preference
\cite{hopkins2014} have all been shown to influence such rates. Thus
...
traits \cite{mayr1965systZool, erwin2007}.  For Phanerozoic marine
invertebrates, Holman \cite{holman1989} has shown that variance in
...
approach as Alroy \cite{alroy08} to insure that only well preserved
...
\cite{alroy08, alroy2010}.  We were motivated to use this method
...
\cite{alroy2010}.  However, subsampling cannot be applied to small
orders (i.e. the majority) because SQS becomes increasingly unreliable
as sample size decreases \cite{alroy2010}.  We therefore develop a
simple method based on first correcting for detection bias using the
``three timer'' correction \cite{alroy08} in which the rate of failure
...
intensive sub-sampling procedures \cite{alroy08, alroy2010}. We
directly compare our predicted time series of global genus diversity
with results derived from SQS \cite{alroy2010} and the raw data
...
level for marine invertebrates. Holman \cite{holman1989} has also
...
\cite{beck2004} and social systems \cite{fuentes2009}.  We do so by
...
systematically through time \cite{liow2007,
...
\begin{figure}
%\centerline{\includegraphics[scale=0.5]{fig_pkx-fbeta.pdf}}
